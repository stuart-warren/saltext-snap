# Salt Extension for Snap

Salt Extension for interacting with Snap
...
The saltext-snap project team welcomes contributions from the community.
...
```bash
# Clone the repo
git clone --origin salt git@github.com:salt-extensions/saltext-snap.git

# Change to the repo dir
cd saltext-snap

# Create a new venv
python3 -m venv env --prompt saltext-snap
...
* Writing blog posts
* Posting on social media about how you used Salt+Snap to solve your
...
[issues]: https://github.com/salt-extensions/saltext-snap/issues
[PRs]: https://github.com/salt-extensions/saltext-snap/pulls
[discussions]: https://github.com/salt-extensions/saltext-snap/discussions
