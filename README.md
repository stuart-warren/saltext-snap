...
The saltext-snap project welcomes contributions from anyone!
...
```bash
# Clone the repo
git clone --origin upstream git@github.com:salt-extensions/saltext-snap.git
...
* Writing blog posts
* Sharing your experiences using Salt + Snap
  on social media
...
[docs]: https://salt-extensions.github.io/saltext-snap/
